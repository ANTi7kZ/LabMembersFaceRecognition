...
_COMPUTE_GRAPH_NAME = 'mobilenet_v1_160res_0.5_imagenet_2.binaryproto'

_OUTPUT_TENSOR_NAME = 'MobilenetV1/Predictions/Softmax'
...
def get_classes(result, max_num_objects=None, object_prob_threshold=0.0):
    ...
    """
    print ("result tensors length")
    print (len(result.tensors))
